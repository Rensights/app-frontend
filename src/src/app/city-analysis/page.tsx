  ...
  return (
    <div className="dashboard-page city-analysis-page">
      ...
      <main className="main-content">
        ...
        <section className="content-section active" style={{ padding: "20px 0" }}>
        ...
        <div id="detailed-analysis" className="top-bar">
          ...
          <div className="executive-summary">
            ...
            <div className="metrics-grid">
              ...
              <a href="#which-to-buy" className="summary-card" onClick={(e) => { e.preventDefault(); handleSectionClick('which-to-buy'); }}>
                <div className="icon">🎯</div>
                <h4>Which Property to Buy</h4>
                <div className="kpi">97% Occupancy</div>
                <p className="insight">Strategic recommendations based on occupancy rates, metro proximity, and market timing</p>
              </a>
              ...
              <a href="#negotiation" className="summary-card" onClick={(e) => { e.preventDefault(); handleSectionClick('negotiation'); }}>
                ...
                <div className="kpi">7.3% Discount</div>
                <p className="insight">Real market value intelligence with comparable sales data and negotiation strategies</p>
              </a>

              <a href="#budget" className="summary-card" onClick={(e) => { e.preventDefault(); handleSectionClick('budget'); }}>
                <div className="icon">💰</div>
                <h4>Analysis by Budget</h4>
                <div className="kpi">7.8% Yield</div>
                <p className="insight">Customized opportunities segmented by budget ranges showing best value propositions</p>
              </a>
            </div>
          </div>
