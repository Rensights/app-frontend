      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16 text-center max-w-3xl mx-auto">
          <h2 className="text-4xl font-bold sm:text-5xl mb-4 bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
            Your Journey to Smart Property Investment
          </h2>
          <p className="text-lg text-muted-foreground">
            A data-driven, step-by-step approach to finding and validating the best property deals in Dubai
          </p>
        </div>
              ...
              >
                ...
                <div className="relative h-full rounded-3xl border-2 border-border bg-card p-8 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 overflow-hidden">
                  ...
                  <div className="relative mb-6">
                    <div className={`absolute inset-0 bg-gradient-to-br ${solution.color} opacity-10 rounded-2xl blur-xl group-hover:blur-2xl transition-all duration-500`} />
                    <div className={`relative flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br ${solution.color} shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500`}>
